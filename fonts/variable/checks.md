...
<details>
<summary><b>[134] Commissioner-VF.ttf</b></summary>
<details>
...
* 🔥 **FAIL** Instance "Thin" wght value is "250.0". It should be "100.0" [code: bad-coordinate]
...
* 🔥 **FAIL** The file 'Commissioner-VF.ttf' must be renamed to 'Commissioner[FLAR,VOLM,slnt,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* 🔥 **FAIL** The NameID.VERSION_STRING (nameID=5) value must follow the pattern "Version X.Y" with X.Y greater than or equal to 1.000. Current version string is: "Version %d.%03d" [code: bad-version-strings]
...
* 🔥 **FAIL** name version string for platform 3, encoding 1 ("Version %d.%03d"), could not be parsed. [code: parse]
...
* ⚠ **WARN** OS/2 VendorID value 'IDKB' is not a known registered id. You should set it to your own 4 character code, and register that code with Microsoft at https://www.microsoft.com/typography/links/vendorlist.aspx [code: unknown]
...
<details>
<summary>⚠ <b>WARN:</b> The variable font 'slnt' (Slant) axis coordinate specifies positive values in its range? </summary>
...
* ⚠ **WARN** The range of values for the "slnt" axis in this font only allows positive coordinates (from 0.0 to 12.0), indicating that this may be a back slanted design, which is rare. If that's not the case, then the "slant" axis should be a range of negative values instead. [code: unusual-range]
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version %d.%03d'] [code: version-not-detected]
...
* ℹ **INFO** Version string is: "Version %d.%03d"
...
* ℹ **INFO** This font contains the following optional tables [loca, GPOS, prep, gasp, GSUB, DSIG]
