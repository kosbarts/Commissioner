...
<details>
<summary><b>[158] Commissioner-fm214[FLAR,VOLM,slnt,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'Commissioner-fm214[FLAR,VOLM,slnt,wght].ttf' must be renamed to 'Commissioner[FLAR,VOLM,slnt,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* ℹ **INFO** Hinting filesize impact:
	...
	|  | ../fonts-tests/variable_fm214/Commissioner-fm214[FLAR,VOLM,slnt,wght].ttf |
	|:--- | ---:|
...
* ℹ **INFO** This font contains the following optional tables [GSUB, prep, gasp, loca, DSIG, GPOS]
