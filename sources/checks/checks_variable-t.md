...
<details>
<summary><b>[153] Commissioner-t[FLAR,VOLM,slnt,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'Commissioner-t[FLAR,VOLM,slnt,wght].ttf' must be renamed to 'Commissioner[FLAR,VOLM,slnt,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* 💤 **SKIP** Font family at '../fonts-tests/variable' lacks a METADATA.pb file.
...
* ℹ **INFO** Hinting filesize impact:
	...
	|  | ../fonts-tests/variable/Commissioner-t[FLAR,VOLM,slnt,wght].ttf |
	|:--- | ---:|
	| Dehinted Size | 425.6kb |
	| Hinted Size | 424.5kb |
	| Increase | -1100 bytes |
	| Change   | -0.3 % |
 [code: size-impact]
...
* ℹ **INFO** This font contains the following optional tables [GPOS, loca, GSUB, prep, gasp, DSIG]
...
* ℹ **INFO** ../fonts-tests/variable [code: family-path]
