...
<details>
<summary><b>[158] Commissioner-fm213[FLAR,VOLM,slnt,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'Commissioner-fm213[FLAR,VOLM,slnt,wght].ttf' must be renamed to 'Commissioner[FLAR,VOLM,slnt,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* ℹ **INFO** Hinting filesize impact:
	...
	|  | ../fonts-tests/variable_fm213/Commissioner-fm213[FLAR,VOLM,slnt,wght].ttf |
	|:--- | ---:|
...
* ℹ **INFO** This font contains the following optional tables [GPOS, GSUB, loca, prep, DSIG, gasp]
