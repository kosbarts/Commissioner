...
mkdir -p ../fonts-tests/static_fm213/ttfs
rm -rf ../fonts-tests/static_fm213/ttfs/*
fontmake -g Commissioner-Variable-Cyrillic-Greek-Ext-production.glyphs -i -a -o ttf --output-dir ../fonts-tests/static_fm213/ttfs/
...
ttfs=$(ls ../fonts-tests/static_fm213/ttfs/*.ttf)
for ttf in $ttfs
do
    # fix DSIG #
...
rm -f ../fonts-tests/static_fm213/ttfs/*backup*.ttf
...
fontbakery check-googlefonts ../fonts-tests/static_fm213/ttfs/*.ttf --ghmarkdown ../sources/checks/checks_static-fm213.md
