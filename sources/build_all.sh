...
fontmake -g Commissioner.glyphs -i -a -o ttf --output-dir ../fonts/static/ttfs/


echo "Generating VFs"
mkdir -p ../fonts/variable
fontmake -g Commissioner.glyphs -o variable --output-path ../fonts/variable/Commissioner[FLAR,VOLM,slnt,wght].ttf
