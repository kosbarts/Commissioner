...
vfs=$(ls ../fonts-tests/variable_fm214/*.ttf)
for vf in $vfs
do
    # fix DSIG #
	echo "fix DSIG in " $vf
	...
	new_file=../fonts-tests/variable_fm214/$rtrip.ttx;
	rm $vf;
	ttx $new_file
	rm $new_file
...
fontbakery check-googlefonts ../fonts-tests/variable_fm214/*.ttf --ghmarkdown ../sources/checks/checks_variable-fm214.md
