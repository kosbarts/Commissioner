...
This is version 1.012. It introduces Tabular Figures and Math symbols, Arrows, missing KaiSymbol, an alternate G (with bar), and a fix in the Greek OT Features. 
